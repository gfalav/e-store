rails g scaffold user first_name:string last_name:string email:string username:string password:digest is_active:boolean is_super_admin:boolean last_login:datetime
...
rails g scaffold category title:string description:string image:string is_active:boolean
rails g scaffold product_id:integer category_id:integer
